class Admin::StandardPollOptionSetsController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @standard_poll_option_set.save
        format.html { redirect_to admin_standard_poll_option_set_path(@standard_poll_option_set), notice: 'Standard poll option set was successfully created.' }
        format.json { render json: admin_stanfard_poll_option_set_path(@standard_poll_option_set), status: :created, location: @standard_poll_option_set }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_standard_poll_option_sets_path }
      format.json { head :no_content }
    end
  end
end
